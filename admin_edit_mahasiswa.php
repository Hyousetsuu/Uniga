...
$sql = "SELECT m.*, u.username, u.name FROM mahasiswa m JOIN users u ON m.user_id = u.id";
...
<body>
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="admin_edit_mahasiswa.php" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Mahasiswa</a>
        ...
        <tr>
            ...
            <td>
                <a class="btn btn-sm btn-primary" href="edit_mahasiswa.php?id=<?php echo htmlspecialchars($row['id']); ?>">Edit</a>
                <a class="btn btn-sm btn-primary" href="hapus_mahasiswa.php?id=<?php echo htmlspecialchars($row['id']); ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus mahasiswa ini?');">Hapus</a>
            </td>
        </tr>
        <?php } ?>

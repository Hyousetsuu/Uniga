        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    <a href="input_absensi.php" class="nav-item nav-link active"><i class="fa fa-th me-2"></i>Absensi</a>
                    <a href="dosen_dashboard.php" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
